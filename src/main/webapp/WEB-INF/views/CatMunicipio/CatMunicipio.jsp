...
<html lang="en">
    <head>
        ...
        <c:url value="/gridCatMunicipio" var="urlgridCatMunicipio" />
        <c:url value="/exportCatMunicipio" var="recordsExportUrlCatMunicipio" />
    </head>
    <body>
        <div class="wrapper">
            <!-- top navbar-->
                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        <div class="jqgrid-responsive mb-lg">
                            <jf:grid urlgrid="${urlgridCatMunicipio}" 
                                     urlexport="${recordsExportUrlCatMunicipio}"
                                     entity="CatMunicipio" 
                                     caption="CatMunicipio grid"
                                     />
                        </div>
                    </div>
                </div>
        ...
        <!-- Modal-->
        <div id="modalCatMunicipio" tabindex="-1" role="dialog" aria-labelledby="myModalLabelLarge" aria-hidden="true" class="modal fade">
           <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <form method="POST" id="formCatMunicipio" action="${urlsaveCatMunicipio}" data-parsley-validate="" novalidate="" class="form-horizontal">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="form-group">
                                         <label class="col-sm-2 control-label">CORRELATIVO DEL MUNICIPIO</label>
                                         <div class="col-lg-10">

                                         <jf:numberbox  precision="10"    id="id" name="id"  required="true" />
                                         </div>
                                     </div>
                                    ...
                                    <div class="form-group">
                                         ...
                                         <jf:textbox  tabindex="2" maxlength="10"   id="idMunicipio" name="idMunicipio"  required="true" />
                                         </div>
                                     </div>
                                    ...
                                    <div class="form-group">
                                         ...
                                         <jf:textbox  tabindex="6" maxlength="200"   id="descripcion" name="descripcion"  required="true" />
                                         </div>
                                     </div>
