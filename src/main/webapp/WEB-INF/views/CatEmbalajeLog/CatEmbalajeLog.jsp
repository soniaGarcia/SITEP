...
<html lang="en">
    <head>
        ...
        <c:url value="/gridCatEmbalajeLog" var="urlgridCatEmbalajeLog" />
        <c:url value="/exportCatEmbalajeLog" var="recordsExportUrlCatEmbalajeLog" />
    </head>
    <body>
        <div class="wrapper">
            <!-- top navbar-->
                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        <div class="jqgrid-responsive mb-lg">
                            <jf:grid urlgrid="${urlgridCatEmbalajeLog}" 
                                     urlexport="${recordsExportUrlCatEmbalajeLog}"
                                     entity="CatEmbalajeLog" 
                                     caption="CatEmbalajeLog grid"
                                     />
                        </div>
                    </div>
                </div>
        ...
        <!-- Modal-->
        <div id="modalCatEmbalajeLog" tabindex="-1" role="dialog" aria-labelledby="myModalLabelLarge" aria-hidden="true" class="modal fade">
           <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <form method="POST" id="formCatEmbalajeLog" action="${urlsaveCatEmbalajeLog}" data-parsley-validate="" novalidate="" class="form-horizontal">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="form-group">
                                         <label class="col-sm-2 control-label">CORRELATIVO DEL EMBALAJE LOG</label>
                                         <div class="col-lg-10">

                                         <jf:numberbox  precision="10"    id="idEmbalajeLog" name="idEmbalajeLog"  required="true" />
                                         </div>
                                     </div>
