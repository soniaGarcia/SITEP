...
<html lang="en">
    <head>
        ...
        <c:url value="/gridIngDecomisoImputado" var="urlgridIngDecomisoImputado" />
        <c:url value="/exportIngDecomisoImputado" var="recordsExportUrlIngDecomisoImputado" />
    </head>
    <body>
        <div class="wrapper">
            <!-- top navbar-->
            ...
            <section>
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <h3>IngDecomisoImputado
                            <small> page</small>
                        </h3>
                        <div class="jqgrid-responsive mb-lg">
                            <jf:grid urlgrid="${urlgridIngDecomisoImputado}" 
                                     urlexport="${recordsExportUrlIngDecomisoImputado}"
                                     entity="IngDecomisoImputado" 
                                     caption="IngDecomisoImputado grid"
                                     />
                        </div>
                    </div>
                </div>
        ...
        <!-- Modal-->
        <div id="modalIngDecomisoImputado" tabindex="-1" role="dialog" aria-labelledby="myModalLabelLarge" aria-hidden="true" class="modal fade">
           <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <form method="POST" id="formIngDecomisoImputado" action="${urlsaveIngDecomisoImputado}" data-parsley-validate="" novalidate="" class="form-horizontal">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="form-group">
                                         <label class="col-sm-2 control-label">ID DEL IMPUTADO</label>
                                         <div class="col-lg-10">
