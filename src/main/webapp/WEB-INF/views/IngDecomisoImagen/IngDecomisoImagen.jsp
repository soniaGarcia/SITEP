...
<html lang="en">
    <head>
        ...
        <c:url value="/gridIngDecomisoImagen" var="urlgridIngDecomisoImagen" />
        <c:url value="/exportIngDecomisoImagen" var="recordsExportUrlIngDecomisoImagen" />
    </head>
    <body>
        <div class="wrapper">
            <!-- top navbar-->
            ...
            <section>
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <h3>IngDecomisoImagen
                            <small> page</small>
                        </h3>
                        <div class="jqgrid-responsive mb-lg">
                            <jf:grid urlgrid="${urlgridIngDecomisoImagen}" 
                                     urlexport="${recordsExportUrlIngDecomisoImagen}"
                                     entity="IngDecomisoImagen" 
                                     caption="IngDecomisoImagen grid"
                                     />
                        </div>
                    </div>
                </div>
        ...
        <!-- Modal-->
        <div id="modalIngDecomisoImagen" tabindex="-1" role="dialog" aria-labelledby="myModalLabelLarge" aria-hidden="true" class="modal fade">
           <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <form method="POST" id="formIngDecomisoImagen" action="${urlsaveIngDecomisoImagen}" data-parsley-validate="" novalidate="" class="form-horizontal">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="form-group">
                                         <label class="col-sm-2 control-label">ID DEL ARCHIVO</label>
                                         <div class="col-lg-10">
