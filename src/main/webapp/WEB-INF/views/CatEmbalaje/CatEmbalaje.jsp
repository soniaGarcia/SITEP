...
<html lang="en">
    <head>
        ...
        <c:url value="/gridCatEmbalaje" var="urlgridCatEmbalaje" />
        <c:url value="/exportCatEmbalaje" var="recordsExportUrlCatEmbalaje" />
    </head>
    <body>
        <div class="wrapper">
            <!-- top navbar-->
                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        <div class="jqgrid-responsive mb-lg">
                            <jf:grid urlgrid="${urlgridCatEmbalaje}" 
                                     urlexport="${recordsExportUrlCatEmbalaje}"
                                     entity="CatEmbalaje" 
                                     caption="CatEmbalaje grid"
                                     />
                        </div>
                    </div>
                </div>
        ...
        <!-- Modal-->
        <div id="modalCatEmbalaje" tabindex="-1" role="dialog" aria-labelledby="myModalLabelLarge" aria-hidden="true" class="modal fade">
           <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <form method="POST" id="formCatEmbalaje" action="${urlsaveCatEmbalaje}" data-parsley-validate="" novalidate="" class="form-horizontal">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="form-group">
                                         <label class="col-sm-2 control-label">CORRELATIVO DEL EMBALAJE</label>
                                         <div class="col-lg-10">
                                    ...
                                    <div class="form-group">
                                         ...
                                         <jf:textbox  tabindex="3" maxlength="7"   id="codigo" name="codigo"  required="true" />
                                         </div>
                                     </div>
                                    ...
                                    <div class="form-group">
                                         ...
                                         <jf:textbox  tabindex="4" maxlength="300"   id="justificacion" name="justificacion" />
                                         </div>
                                     </div>
