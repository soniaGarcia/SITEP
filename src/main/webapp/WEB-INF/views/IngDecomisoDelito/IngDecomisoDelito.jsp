...
<html lang="en">
    <head>
        ...
        <c:url value="/gridIngDecomisoDelito" var="urlgridIngDecomisoDelito" />
        <c:url value="/exportIngDecomisoDelito" var="recordsExportUrlIngDecomisoDelito" />
    </head>
    <body>
        <div class="wrapper">
            <!-- top navbar-->
            ...
            <section>
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <h3>IngDecomisoDelito
                            <small> page</small>
                        </h3>
                        <div class="jqgrid-responsive mb-lg">
                            <jf:grid urlgrid="${urlgridIngDecomisoDelito}" 
                                     urlexport="${recordsExportUrlIngDecomisoDelito}"
                                     entity="IngDecomisoDelito" 
                                     caption="IngDecomisoDelito grid"
                                     />
                        </div>
                    </div>
                </div>
        ...
        <!-- Modal-->
        <div id="modalIngDecomisoDelito" tabindex="-1" role="dialog" aria-labelledby="myModalLabelLarge" aria-hidden="true" class="modal fade">
           <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <form method="POST" id="formIngDecomisoDelito" action="${urlsaveIngDecomisoDelito}" data-parsley-validate="" novalidate="" class="form-horizontal">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="form-group">
                                         <label class="col-sm-2 control-label">ID DEL DELITO</label>
                                         <div class="col-lg-10">
                                    ...
                                    <div class="form-group">
                                         ...
                                         <jf:textbox  tabindex="2" maxlength="300"   id="delito" name="delito"  required="true" />
                                         </div>
                                     </div>
