...
<html lang="en">
    <head>
        ...
        <c:url value="/gridIngDecomisoMonedaLog" var="urlgridIngDecomisoMonedaLog" />
        <c:url value="/exportIngDecomisoMonedaLog" var="recordsExportUrlIngDecomisoMonedaLog" />
    </head>
    <body>
        <div class="wrapper">
            <!-- top navbar-->
            ...
            <section>
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <h3>IngDecomisoMonedaLog
                            <small> page</small>
                        </h3>
                        <div class="jqgrid-responsive mb-lg">
                            <jf:grid urlgrid="${urlgridIngDecomisoMonedaLog}" 
                                     urlexport="${recordsExportUrlIngDecomisoMonedaLog}"
                                     entity="IngDecomisoMonedaLog" 
                                     caption="IngDecomisoMonedaLog grid"
                                     />
                        </div>
                    </div>
                </div>
        ...
        <!-- Modal-->
        <div id="modalIngDecomisoMonedaLog" tabindex="-1" role="dialog" aria-labelledby="myModalLabelLarge" aria-hidden="true" class="modal fade">
           <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <form method="POST" id="formIngDecomisoMonedaLog" action="${urlsaveIngDecomisoMonedaLog}" data-parsley-validate="" novalidate="" class="form-horizontal">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="form-group">
                                         <label class="col-sm-2 control-label">ID DE LA MONEDA LOG</label>
                                         <div class="col-lg-10">

                                         <jf:numberbox  precision="10"    id="idDecomisoMonedaLog" name="idDecomisoMonedaLog"  required="true" />
                                         </div>
                                     </div>
                                    ...
                                    <div class="form-group">
                                         ...
                                         <jf:datetime tabindex="3"   id="fCreaFecha" name="fCreaFecha" />
                                         </div>
                                     </div>
                                    ...
                                    <div class="form-group">
                                         ...
                                         <jf:textbox  tabindex="9" maxlength="20"   id="moneda" name="moneda"  required="true" />
                                         </div>
                                     </div>
