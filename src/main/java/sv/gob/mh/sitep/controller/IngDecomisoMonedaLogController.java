...
import sv.gob.mh.sitep.repository.IngDecomisoMonedaLogRepository;
...
@Controller
@RequestMapping("/")
public class IngDecomisoMonedaLogController {
    
    @Autowired
    IngDecomisoMonedaLogRepository ingDecomisoMonedaLogRepository;
    ...
    * @version 1.0
    */
    @RequestMapping("/indexIngDecomisoMonedaLog")
    public ModelAndView indexIngDecomisoMonedaLog(){
        ModelAndView mv = new ModelAndView();
        mv.addObject("ingDecomisoMonedaLog", new IngDecomisoMonedaLog());
        mv.setViewName("IngDecomisoMonedaLog/IngDecomisoMonedaLog.jsp");
        return mv;
    }
    ...
    * @version 1.0
    */
    @RequestMapping(value = "/saveIngDecomisoMonedaLog", method = RequestMethod.POST)
    public @ResponseBody String saveIngDecomisoMonedaLog(@ModelAttribute("IngDecomisoMonedaLog") @Validated IngDecomisoMonedaLog ingDecomisoMonedaLog ) {
         ingDecomisoMonedaLogRepository.save(ingDecomisoMonedaLog);
         return null;
     }
    ...
    * @version 1.0
    */
    @RequestMapping(value = "/deleteIngDecomisoMonedaLog", method = RequestMethod.POST)
    public @ResponseBody String deleteIngDecomisoMonedaLog(@ModelAttribute("IngDecomisoMonedaLog")  IngDecomisoMonedaLog ingDecomisoMonedaLog ) {
         ingDecomisoMonedaLogRepository.delete(ingDecomisoMonedaLog);
         return null;
     }
    ...
    * @version 1.0
    */
    @RequestMapping(value = "/gridIngDecomisoMonedaLog", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
    public @ResponseBody JqgridResponse<IngDecomisoMonedaLog> gridIngDecomisoMonedaLog(
        @RequestParam(value = "filters", required = false) String filters,
        @RequestParam(value = "page", required = false) Integer page,
        @RequestParam(value = "rows", required = false) Integer rows
    ) {
    
        Page<IngDecomisoMonedaLog> list = ingDecomisoMonedaLogRepository.findByFilters(
            new PageRequest(page - 1, rows)
           ,JqgridFilter.getField(filters, "idDecomisoMonedaLog") 
       ...
       JqgridResponse<IngDecomisoMonedaLog> jqgridIngDecomisoMonedaLog = new JqgridResponse<IngDecomisoMonedaLog>();
       return jqgridIngDecomisoMonedaLog.jGridFill(list, page, rows);
    }
    ...
    * @version 1.0
    */
    @RequestMapping(value = "/exportIngDecomisoMonedaLog", method = RequestMethod.POST, produces = "application/json;charset=UTF-8")
    public void exportIngDecomisoMonedaLog(
        ...
        header.add("idDecomisoMonedaLog"); 
        ...
        LayOutDynamic.buildReport(worksheet, "IngDecomisoMonedaLog", header);
        
        List<Object[]> list = ingDecomisoMonedaLogRepository.findByFilters(
           JqgridFilter.getField(filters, "idDecomisoMonedaLog") 
            ,JqgridFilter.getField(filters, "fModFecha") 
            ,JqgridFilter.getField(filters, "fCreaFechaLog") 
            ,JqgridFilter.getField(filters, "fCreaFecha") 
       ...
       String fileName = "IngDecomisoMonedaLog.xls";
