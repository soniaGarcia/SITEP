...
import sv.gob.mh.sitep.repository.IngDecomisoVictimaRepository;
...
@Controller
@RequestMapping("/")
public class IngDecomisoVictimaController {
    
    @Autowired
    IngDecomisoVictimaRepository ingDecomisoVictimaRepository;
    ...
    * @version 1.0
    */
    @RequestMapping("/indexIngDecomisoVictima")
    public ModelAndView indexIngDecomisoVictima(){
        ModelAndView mv = new ModelAndView();
        mv.addObject("ingDecomisoVictima", new IngDecomisoVictima());
        mv.setViewName("IngDecomisoVictima/IngDecomisoVictima.jsp");
        return mv;
    }
    ...
    * @version 1.0
    */
    @RequestMapping(value = "/saveIngDecomisoVictima", method = RequestMethod.POST)
    public @ResponseBody String saveIngDecomisoVictima(@ModelAttribute("IngDecomisoVictima") @Validated IngDecomisoVictima ingDecomisoVictima ) {
         ingDecomisoVictimaRepository.save(ingDecomisoVictima);
         return null;
     }
    ...
    * @version 1.0
    */
    @RequestMapping(value = "/deleteIngDecomisoVictima", method = RequestMethod.POST)
    public @ResponseBody String deleteIngDecomisoVictima(@ModelAttribute("IngDecomisoVictima")  IngDecomisoVictima ingDecomisoVictima ) {
         ingDecomisoVictimaRepository.delete(ingDecomisoVictima);
         return null;
     }
    ...
    * @version 1.0
    */
    @RequestMapping(value = "/gridIngDecomisoVictima", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
    public @ResponseBody JqgridResponse<IngDecomisoVictima> gridIngDecomisoVictima(
        @RequestParam(value = "filters", required = false) String filters,
        @RequestParam(value = "page", required = false) Integer page,
        @RequestParam(value = "rows", required = false) Integer rows
    ) {
    
        Page<IngDecomisoVictima> list = ingDecomisoVictimaRepository.findByFilters(
       ...
       JqgridResponse<IngDecomisoVictima> jqgridIngDecomisoVictima = new JqgridResponse<IngDecomisoVictima>();
       return jqgridIngDecomisoVictima.jGridFill(list, page, rows);
    }
    ...
    * @version 1.0
    */
    @RequestMapping(value = "/exportIngDecomisoVictima", method = RequestMethod.POST, produces = "application/json;charset=UTF-8")
    public void exportIngDecomisoVictima(
        ...
        LayOutDynamic.buildReport(worksheet, "IngDecomisoVictima", header);
        
        List<Object[]> list = ingDecomisoVictimaRepository.findByFilters(
           JqgridFilter.getField(filters, "idDecomisoVictima") 
            ,JqgridFilter.getField(filters, "fModFecha") 
            ,JqgridFilter.getField(filters, "nombre") 
            ,JqgridFilter.getField(filters, "fCreaFecha") 
       ...
       String fileName = "IngDecomisoVictima.xls";
