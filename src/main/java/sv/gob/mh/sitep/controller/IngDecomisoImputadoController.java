...
import sv.gob.mh.sitep.repository.IngDecomisoImputadoRepository;
...
@Controller
@RequestMapping("/")
public class IngDecomisoImputadoController {
    
    @Autowired
    IngDecomisoImputadoRepository ingDecomisoImputadoRepository;
    ...
    * @version 1.0
    */
    @RequestMapping("/indexIngDecomisoImputado")
    public ModelAndView indexIngDecomisoImputado(){
        ModelAndView mv = new ModelAndView();
        mv.addObject("ingDecomisoImputado", new IngDecomisoImputado());
        mv.setViewName("IngDecomisoImputado/IngDecomisoImputado.jsp");
        return mv;
    }
    ...
    * @version 1.0
    */
    @RequestMapping(value = "/saveIngDecomisoImputado", method = RequestMethod.POST)
    public @ResponseBody String saveIngDecomisoImputado(@ModelAttribute("IngDecomisoImputado") @Validated IngDecomisoImputado ingDecomisoImputado ) {
         ingDecomisoImputadoRepository.save(ingDecomisoImputado);
         return null;
     }
    ...
    * @version 1.0
    */
    @RequestMapping(value = "/deleteIngDecomisoImputado", method = RequestMethod.POST)
    public @ResponseBody String deleteIngDecomisoImputado(@ModelAttribute("IngDecomisoImputado")  IngDecomisoImputado ingDecomisoImputado ) {
         ingDecomisoImputadoRepository.delete(ingDecomisoImputado);
         return null;
     }
    ...
    * @version 1.0
    */
    @RequestMapping(value = "/gridIngDecomisoImputado", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
    public @ResponseBody JqgridResponse<IngDecomisoImputado> gridIngDecomisoImputado(
        @RequestParam(value = "filters", required = false) String filters,
        @RequestParam(value = "page", required = false) Integer page,
        @RequestParam(value = "rows", required = false) Integer rows
    ) {
    
        Page<IngDecomisoImputado> list = ingDecomisoImputadoRepository.findByFilters(
       ...
       JqgridResponse<IngDecomisoImputado> jqgridIngDecomisoImputado = new JqgridResponse<IngDecomisoImputado>();
       return jqgridIngDecomisoImputado.jGridFill(list, page, rows);
    }
    ...
    * @version 1.0
    */
    @RequestMapping(value = "/exportIngDecomisoImputado", method = RequestMethod.POST, produces = "application/json;charset=UTF-8")
    public void exportIngDecomisoImputado(
        ...
        LayOutDynamic.buildReport(worksheet, "IngDecomisoImputado", header);
        
        List<Object[]> list = ingDecomisoImputadoRepository.findByFilters(
           JqgridFilter.getField(filters, "idDecomisoImputado") 
            ,JqgridFilter.getField(filters, "fModFecha") 
            ,JqgridFilter.getField(filters, "nombre") 
            ,JqgridFilter.getField(filters, "fCreaFecha") 
       ...
       String fileName = "IngDecomisoImputado.xls";
