...
public class IngDecomisoImagenLog implements Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    @Basic(fetch = FetchType.EAGER)
    @Column(name = "ID_DECOMISO_IMAGEN_LOG", nullable = false)
    @JsonView
    @GeneratedValue(strategy =GenerationType.AUTO, generator = "SEQ_ING_DECOMISO_IMAGEN_LOG")
    @SequenceGenerator(name="SEQ_ING_DECOMISO_IMAGEN_LOG",sequenceName="SEQ_ING_DECOMISO_IMAGEN_LOG")
    Integer idDecomisoImagenLog;
    ...
    @NotNull(message ="No puede estar vacio el campo idDecomisoImagen")
