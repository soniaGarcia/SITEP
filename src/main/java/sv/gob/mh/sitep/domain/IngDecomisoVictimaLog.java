...
public class IngDecomisoVictimaLog implements Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    @Basic(fetch = FetchType.EAGER)
    @Column(name = "ID_DECOMISO_VICTIMA_LOG", nullable = false)
    @JsonView
    @GeneratedValue(strategy =GenerationType.AUTO, generator = "SEQ_ING_DECOMISO_VICTIMA_LOG")
    @SequenceGenerator(name="SEQ_ING_DECOMISO_VICTIMA_LOG",sequenceName="SEQ_ING_DECOMISO_VICTIMA_LOG")
    Integer idDecomisoVictimaLog;
    ...
    @NotNull(message ="No puede estar vacio el campo idDecomisoVictima")
    @Column(name = "ID_DECOMISO_VICTIMA", nullable = false)
    @JsonView
    Integer idDecomisoVictima;
