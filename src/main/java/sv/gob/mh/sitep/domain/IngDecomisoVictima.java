...
public class IngDecomisoVictima implements Serializable {
    ...
    @JsonView
    @GeneratedValue(strategy =GenerationType.AUTO, generator = "SEQ_ING_DECOMISO_VICTIMA")
    @SequenceGenerator(name="SEQ_ING_DECOMISO_VICTIMA",sequenceName="SEQ_ING_DECOMISO_VICTIMA")
