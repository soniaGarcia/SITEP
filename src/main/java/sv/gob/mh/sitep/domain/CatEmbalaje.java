...
public class CatEmbalaje implements Serializable {
    ...
    @JsonView
    @GeneratedValue(strategy =GenerationType.AUTO, generator = "SEQ_CAT_EMBALAJE")
    @SequenceGenerator(name="SEQ_CAT_EMBALAJE",sequenceName="SEQ_CAT_EMBALAJE")
    Integer idEmbalaje;
    ...
    @OneToMany(mappedBy = "catEmbalaje", cascade = {CascadeType.REMOVE}, fetch = FetchType.LAZY)
    @Getter(onMethod = @__(@JsonIgnore))
