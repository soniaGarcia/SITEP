...
public class CatEmbalajeLog implements Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    @Basic(fetch = FetchType.EAGER)
    @Column(name = "ID_EMBALAJE_LOG", nullable = false)
    @JsonView
    @GeneratedValue(strategy =GenerationType.AUTO, generator = "SEQ_CAT_EMBALAJE_LOG")
    @SequenceGenerator(name="SEQ_CAT_EMBALAJE_LOG",sequenceName="SEQ_CAT_EMBALAJE_LOG")
    Integer idEmbalajeLog;
